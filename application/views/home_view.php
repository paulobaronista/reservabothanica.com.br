    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 padding-off">
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 img-lazer">
                    <a href="<?= base_url(); ?>assets/images/galeria/VER_3 - Foto.jpg" data-lightbox="galeria">
                        <img class="img-responsive center-block" src="<?= base_url(); ?>assets/images/portaria.jpg" alt="Portaria">
                    </a>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 img-lazer">
                    <a href="<?= base_url(); ?>assets/images/galeria/17.jpg" data-lightbox="galeria">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 img-lazer">
                    <a href="<?= base_url(); ?>assets/images/galeria/BOTHANICA_59.jpg" data-lightbox="galeria">
                        <img class="img-responsive center-block" src="<?= base_url(); ?>assets/images/quadra-tenis.jpg" alt="Quadra de Tênis">
                    </a>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 img-lazer">
                    <a href="<?= base_url(); ?>assets/images/galeria/BOTHANICA_32.jpg" data-lightbox="galeria">
                        <img class="img-responsive center-block" src="<?= base_url(); ?>assets/images/fitness.jpg" alt="Fitness">
                    </a>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 img-lazer">
                    <a href="<?= base_url(); ?>assets/images/galeria/02_18-Foto.jpg" data-lightbox="galeria">
                        <img class="img-responsive center-block" src="<?= base_url(); ?>assets/images/gourmet.jpg" alt="Espaço Gourmet">
                    </a>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 img-lazer">
                    <a href="<?= base_url(); ?>assets/images/galeria/BOTHANICA_31.jpg" data-lightbox="galeria">
...
<div class="container-fluid padding-off boxTexto">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
                <p>
                    RESERVA BOTHANICA E UM GRANDIOSO PROJETO<br>
                    ARQUITETÔNICO, URBANÍSTICO E PAISAGÍSTICO,<br>
                    ASSINADO POR DOIS GRANDES NOMES DO MERCADO.
                </p>
            </div>
        </div>
    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="media">
                        <div class="media-left media-middle">
                            <img class="media-object" src="<?= base_url(); ?>assets/images/benedito.jpg" alt="Benedito Abbud">
                            <img class="img-responsive center-block margin-top-30" src="<?= base_url(); ?>assets/images/logo-benedito-abbud-layout.png" alt="Benedito Abbud">
                        </div>
                ...
                <form method="post" role="form" action="<?php echo base_url("contato") ?>">
                    <div class="group-form">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="col-xs-8 col-sm-10 col-md-10 dt"></div>
                            <div class="col-xs-4 col-sm-2 col-md-2" style="padding-right: 0;">
