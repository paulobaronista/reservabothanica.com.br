...
<div class="galeria wow fadeInUp" data-wow-delay="1s">
    <section class="galeria-reserva slider">
        ...
        <div>
            <img class="img-responsive center-block hidden-xs" src="<?= base_url(); ?>assets/images/galeria-02.jpg" alt="Reserva Bothanica">
                ...
                <form method="post" role="form" action="<?php echo base_url("homeContato") ?>">
                    <div class="group-form">
                        <div class="col-xs-12 col-sm-3 col-md-3">
                            <input id="homeNome" type="text" class="homeNome form-control" name="homeNome" required="required" placeholder="Nome*" />
                        </div>
                        <div class="col-xs-12 col-sm-3 col-md-3">
                            <input id="homeEmail" type="email" class="homeEmail form-control" name="homeEmail" required="required" placeholder="E-mail*" />
                        </div>
                        <div class="col-xs-12 col-sm-3 col-md-3">
                            <input id="homePhone" class="homePhone form-control" type="tel" name="homePhone" required="required" placeholder="Telefone*" />
                        </div>
                        <div class="col-xs-12 col-sm-3 col-md-3">
...
<div id="aviso" class="aviso text-center">
    <div>
        ...
        <p>O e-mail não pode ser enviado!<br />
            ...
            Se o problema persistir, entre em contato pelo E-mail <strong>contato@terradouradainc.com.br</strong>
        </p>
    </div>
</div>